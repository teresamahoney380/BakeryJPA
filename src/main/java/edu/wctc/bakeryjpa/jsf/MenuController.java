...
import edu.wctc.bakeryjpa.jsf.util.JsfUtil;
import edu.wctc.bakeryjpa.jsf.util.PaginationHelper;
...
public class MenuController implements Serializable {
    ...
    @EJB
    private edu.wctc.bakeryjpa.ejb.MenuFacade ejbFacade;
    ...
    public static class MenuControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Menu) {
                Menu o = (Menu) object;
                return getStringKey(o.getMenuId());
            } else {
